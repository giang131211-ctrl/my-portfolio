...
<div id="home" class="page active">
    <header>
        <h1>Xin chào! Mình là Nguyễn Trường Giang</h1>
        <p>Web Developer tương lai</p>
    </header>
...
<div id="about" class="page">
    <section>
        <h1>Giới thiệu</h1>
        <img src="https://tuanluupiano.com/wp-content/uploads/2026/02/avatar-shin-cute-17.jpg" width="200" style="border-radius:50%;">
        <p>Tôi là Nguyễn Trường Giang.</p>
    </section>
</div>
...
<div id="contact" class="page">
    <section>
        <h1>Liên hệ</h1>
        <p>Email: giang131211@gmail.com</p>
    </section>
</div>
